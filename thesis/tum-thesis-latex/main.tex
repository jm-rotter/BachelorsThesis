...
\newcommand*{\getTitle}{Persistent GPU Threads for Real Time System Scheduling}
\newcommand*{\getTitleGer}{Persistente GPU Threads für die Echtzeit Systemplanung}
\newcommand*{\getAuthor}{Jaden Rotter}
\newcommand*{\getDoctype}{Bachelor's Thesis}
\newcommand*{\getSupervisor}{Michael Gerndt}
\newcommand*{\getAdvisor}{Jianfeng Gu}
\newcommand*{\getKeywords}{keyword;another keyword;one more}
\newcommand*{\getSubmissionDate}{August 18th, 2025}
...
\input{chapters/01a_objectives.tex}
\input{chapters/02_background.tex}
\input{chapters/03_related_work.tex}
%\input{chapters/03_objectives.tex}

\input{chapters/05_persistent_threads.tex}
\input{chapters/06_evaluation.tex}

%\input{chapters/04_literature_review.tex}
%\input{chapters/05_proposed_approach.tex}
