...
The open source driving project, Apollo\footnote{For more information, visit the GitHub repository: \url{https://github.com/ApolloAuto/apollo}}, is being developed by Baidu and currently uses a coroutine scheduler in combination with a real time OS for its \acs{CPU} tasks, but does not support the same features for its \acs{GPU} tasks.
