...
The increasing use of GPUs in real time systems has led to the development of custom programming models both reducing kernel launch overhead and improving predictable GPU scheduling.
Applications in domains such as robotics, autonomous systems, and scientific computing increasingly adopt these models to minimize execution latency, improve resource utilization, and ensure timing determinism.
These applications can be generally divided into three categories: compiler driven frameworks, runtime scheduling frameworks, and manual implementations.
