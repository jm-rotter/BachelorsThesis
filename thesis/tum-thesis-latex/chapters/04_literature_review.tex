...
In this paper, a flexible \ac{DSL} was presented, which allowed the writing in a mega-kernel fashion with \texttt{$suspend} statements to define suspention marks, to define a coroutine.
