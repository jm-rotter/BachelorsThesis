...
The autnomous driving platform, Apollo, which serves as the primary motivation for this thesis, illustrates this challenge. 
...
Modern GPUs do not natively support real time programming models in the same way CPUs do.
